...
i = 0
nbags = 10
nepochs = 60 # yy:added 5
pred_oob = np.zeros(xtrain.shape[0])
pred_test = np.zeros(xtest.shape[0])

# nfolds cv -> train a nnet #bags times to average -> everytime repeat epoch times -> everytime sample batches samples
